...
const en: Dictionary = {
  ...
  internal: {
    ...
    insightsLead: "A sample from the corpus — notes, insights and resources alongside each other.",
    noInsights: "Nothing to show yet. The first one entered will show up here.",
    loadMoreInsights: "Load more",
  ...
  contact: {
    launcher: "Message",
    openLauncherLabel: "Send a message",
    closeLauncherLabel: "Close the message box",
    panelLabel: "Send a message",
    title: "Send a message",
    subtitle: "Goes straight to the platform team.",
    close: "Close",

    subjectLabel: "Subject (optional)",
    subjectPlaceholder: "Briefly, what it is about",
    messageLabel: "Message",
    messagePlaceholder: "Write your message here…",
    send: "Send message",
    sending: "Sending…",
    sentFromAccount: "Sent from the account you are signed in with.",

    sentTitle: "Your message has been sent.",
    sentBody: "Thanks — it is in the inbox now.",
    again: "Write another",

    errorEmpty: "Write a message first.",
    errorTooLong: "The message is {n} characters — the limit is {max}.",
    errorUnauthorized: "You have to be signed in to send a message.",
    errorBadRequest: "Something was wrong with the request. Reload the page.",
    errorNotConfigured: "The contact form is not set up.",
    errorSendFailed: "The email could not be sent. Try again shortly.",
    errorGeneric: "The message was not sent. Try again.",
