...
const no = {
  ...
  internal: {
    ...
    insightsHeading: "Innsikter",
    insightsLead: "Et utvalg fra korpuset — notater, innsikter og ressurser om hverandre.",
    noInsights: "Ingenting å vise ennå. Det første som legges inn, dukker opp her.",
    loadMoreInsights: "Last inn flere",
